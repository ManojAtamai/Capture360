...
typedef NS_ENUM(NSUInteger, INSApplyVirtualGimbalRectType) {
    INSApplyVirtualGimbalRectTypeApply, /// 当数据有变更之后就应用
    INSApplyVirtualGimbalRectTypeForceApply, /// 强制应用推流数据
    INSApplyVirtualGimbalRectTypeNone, /// 不应用推流数据
};
...
@property (nonatomic) INSApplyVirtualGimbalRectType shouldApplyVirtualGimbalRect;
...
- (void)openWithHandle:(void (^)(InsGyroInfo *, NSError *))handle;
