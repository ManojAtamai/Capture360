...
/*!
 *  for reader
 *  userInfo - {"storageInfos": [INSStorageInfo]}
 */
extern NSString *const INSReaderStorageStateNotification;

/*!
 *  for usb sandbox
 *  userInfo - {"usbSandboxShouldAuth": YES}
 */
extern NSString *const INSUsbSandboxUnauthorizedNotification;
...
// */
//@property (nonatomic, nonnull, readonly) id commandManager;
@property (nonatomic, strong, readonly) INSCameraCommandManager *commandsImpl;
...
@property (nonatomic,strong,readonly) INSCameraManagerConnectedExtraInfo *extraInfo;
