...
#import <INSCameraServiceSDK/INSCameraManagerConnectedExtraInfo.h>

typedef NS_ENUM(NSUInteger, INSBluetoothManageState) {
    INSBluetoothManageStateBluetoothUnknown,
    ...
    INSBluetoothManageStateBluetoothDisable,
    ...
    INSBluetoothManageStateBluetoothUnauthorized,
...
@property (nonatomic, assign) INSBluetoothConnectionState connectionState;
...
///is system bluetooth inited success
@property (nonatomic,readonly) BOOL isCentralManagerStateHadInited;

/// device connected costime extra info
@property (nonatomic, strong, readonly) INSBluetoothConnectedExtraInfo *extraInfo;
 ...
 */
- (id)getCommandManagerByDevice:(INSBluetoothDevice *)device;
