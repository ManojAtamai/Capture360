...
#import <INSCameraServiceSDK/INSPtzMovementStatus.h>
...
typedef NS_ENUM(NSUInteger, INSCameraGammaMode) {
    ...
    INSCameraGammaModePortrait = 14,
    INSCameraGammaModeLeica1 = 15,
    INSCameraGammaModeLeica2 = 16,
    INSCameraGammaModeFilm = 17,
    INSCameraGammaModeVintage = 18,
    INSCameraGammaModeUrban = 19,
    INSCameraGammaModeNight = 20,
    INSCameraGammaModeClear = 21,
    INSCameraGammaModeGlow = 22,
    INSCameraGammaModeSelfie = 23
};
...
typedef NS_ENUM(uint16_t, INSPhotographyOptionsType) {
    ...
    /// 水平防抖
    INSPhotographyOptionsTypeHorizonEnable = 70,
    
    /// 夜景增强开关
    INSPhotographyOptionsTypePureVideoEnhancType = 71,
    
    /// I-Log开关
    INSPhotographyOptionsTypeILogSwitch = 72,
    
    ///预览还原开关
    INSPhotographyOptionsTypeColorRecoverySwitch = 73,
    
    /// 虚拟云台欧拉角
    INSPhotographyOptionsTypeRenderVlpEuler = 74,
    
    /// 虚拟云台全景与广角分辨率
    INSPhotographyOptionsTypeRenderVlpRes = 75,
    
    /// 虚拟云台视角参数
    INSPhotographyOptionsTypeRenderVlpFov = 76,
    
    /// 拍照模式HDR开关状态
    INSPhotographyOptionsTypePhotoHdrType = 77,

    /// 虚拟云台畸变矫正
    INSPhotographyOptionsTypeRenderDistortionCorrection = 78,

    /// 虚拟云台玩法状态
    INSPhotographyOptionsTypeVirtualPtzMovementStatus = 79,

    /// 虚拟云台设置构图中心点
    INSPhotographyOptionsTypeRenderCenterPoint = 80,
    
    /// 虚拟云台自定义视角fov
    INSPhotographyOptionsTypePtzFovFactor = 81,
    
    /// 虚拟云台追踪复位
    INSPhotographyOptionsTypeTrackingReset = 82,
    
    ///人像模式开关
    INSPhotographyOptionsTypeFaceOptimizeMode = 83,

    /** 虚拟云台四元数 */
    INSPhotographyOptionsTypeRenderVlpQuat = 84,
    
    /** livephoto开关 */
    INSPhotographyOptionsTypeLivephotoMode = 85,

    /** P3开关 */
    INSPhotographyOptionsTypeP3Switch = 86,
    
    /** p3 其他参数*/
    INSPhotographyOptionsTypeP3ExtendParam = 87,
    
    /** 微距镜开关*/
    INSPhotographyOptionsTypeMacrolensSwitchMode = 88,
    
    /** 美颜开关*/
    INSPhotographyOptionsTypeBeautySwitch = 89,
    
    /** 美颜参数*/
    INSPhotographyOptionsTypeBeautyParam = 90
};
...
typedef NS_ENUM(NSUInteger, INSPhotographyOptionsPTZFOVVlp) {
    INSPhotographyOptionsPTZFOVVlpBack,
    INSPhotographyOptionsPTZFOVVlpFront,
    INSPhotographyOptionsPTZFOVVlpTop,
    INSPhotographyOptionsPTZFOVVlpBottom,
    INSPhotographyOptionsPTZFOVVlpTrack,
    INSPhotographyOptionsPTZFOVVlpAdvance,
    INSPhotographyOptionsPTZFOVVlpFree,
};
...
@interface INSCameraRenderCenterPoint : NSObject
...
@interface INSCameraFunctionMode : NSObject

@property (nonatomic) uint functionMode;

- (instancetype)initWithFunctionMode:(uint)mode;

@end

@interface INSCameraRenderVlpEuler : NSObject
...
@interface INSCameraRenderVlpQuat : NSObject

@property (nonatomic) float quat_x;

@property (nonatomic) float quat_y;

@property (nonatomic) float quat_z;

@property (nonatomic) float quat_w;

@end

@interface INSCameraRenderVlpFov : NSObject

@property (nonatomic) INSPhotographyOptionsPTZFOVVlp currentFov;

@property (nonatomic) INSPhotographyOptionsPTZFOVVlp fixedFov;

@end

@interface INSRenderVlpResolution : NSObject

@property (nonatomic) INSVideoResolution panoResolution;

@property (nonatomic) INSVideoResolution subResolution;

@end

@interface INSCameraExposureStatus : NSObject

@property (nullable, nonatomic) INSCameraFunctionMode *mode;
...
@interface INSP3ExternParam : NSObject

@property (nonatomic, assign) uint32_t evmapLevel;
@property (nonatomic, assign) uint32_t aeState;
...
* LivePhoto 切换状态通知
**/
@interface INSLivePhotoSwitch : NSObject

/** 错误码 */
@property(nonatomic) uint32_t errorCode;

/** LivePhoto 状态类型 */
@property(nonatomic) uint32_t livePhotoType;

@end

/// 美颜参数
@interface INSBeautyParam : NSObject

@property (nonatomic, assign) float skinCareStrength;
@property (nonatomic, assign) float blemishRemovalStrength;
...
@property (nonatomic) uint8_t fovType;
...
// 水平矫正开关
@property (nonatomic) BOOL horizontalEnable;
// 防抖等级
@property (nonatomic) uint8_t flowStateLevel;
/// Burst连拍张数
...
/** CV5防抖等级 */
@property(nonatomic) uint8_t flowStateLevelByCv5;
...
/** 全景曝光模式 */
@property(nonatomic) uint8_t panoExposureMode;

/** 跟拍模式 */
@property(nonatomic) uint8_t selfieMode;
/** HDR开关状态 */
@property(nonatomic) BOOL hdrSwitchStatus;

/** 拍照HDR开关模式状态 */
@property(nonatomic) uint32_t photoHdrType;

/** 夜景增强开关 */
@property(nonatomic) BOOL purevideoEnhancSwitch;

/** 预览还原开关 */
@property(nonatomic) BOOL colorRecoverySwitch;

/** I-Log开关*/
@property(nonatomic) BOOL iLogSwitch;

/** 人像模式开关*/
@property(nonatomic) BOOL faceOptimizeMode;
...
@property(nullable, nonatomic) INSCameraRenderVlpEuler *renderVlpEuler;

@property(nullable, nonatomic) INSCameraRenderVlpQuat *renderVlpQuat;

@property(nullable, nonatomic) INSRenderVlpResolution *renderVlpResolution;

@property(nullable, nonatomic) INSCameraRenderVlpFov *renderVlpFov;

@property(nonatomic) uint32_t renderDistortionCorrection;

@property(nullable, nonatomic) INSCameraRenderCenterPoint *centerPoint;

@property(nullable, nonatomic) INSPtzMovementStatus *ptzMovementStatus;

/** 动态fov值, 传的是realFov的值*/
@property(nonatomic) uint32_t ptzFovFactor;

/** 虚拟云台追踪复位 */
@property(nonatomic) BOOL trackingReset;

/** 拍照Livephoto开关模式状态 */
@property(nonatomic) INSLivePhotoSwitch *photoSwitch;

/** 0: 关闭 1:开启 */
@property(nonatomic) BOOL p3Switch;

@property (nonatomic, strong) INSP3ExternParam *p3ExternParam;

@property(nonatomic) BOOL macrolensSwitchMode;

@property(nonatomic) BOOL beautySwitch;

@property(nonatomic, strong) INSBeautyParam *beautyParam;
